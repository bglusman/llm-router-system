...
class ModelSetup {
  ...
  async setupModels() {
    ...
    const models = [
      { name: 'llama3.2:3b', description: 'Fast classification model (2GB)' },
      { name: 'llama3.1:8b', description: 'General processing model (5GB)' },
      { name: 'llama3.2-vision:11b', description: 'Vision analysis model (7GB)' },
      { name: 'deepseek-coder:6.7b', description: 'Document processing model (4GB)' },
      { name: 'llama3.1:70b', description: 'Advanced reasoning model (35GB - optional)' }
    ];
  ...
  async pullModel(modelName) {
    ...
    // In a real implementation, you'd track the pull progress
